...
var reviews = [4.5, 4.0, 5.0, 2.0, 1.0, 5.0, 3.0, 4.0, 1.0, 5.0, 4.5, 3.0, 2.5, 2.0];

var reducer = function reducer(a, b) {
  return _objectSpread({}, a, _defineProperty({}, b, 1 + (a[b] ? a[b] : 0)));
};

var result = reviews.reduce(reducer, {});
console.log(result);
